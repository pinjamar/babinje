...
def send_email(item: BabinjeItem, name: str, email: str, isRegister: bool, action_url: str):
    from . import mail_builder

    email_contents = mail_builder.generate_message(name, isRegister, item.name, action_url)
