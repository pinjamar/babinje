...
response = requests.post(BASE_HOST + "/api/v1/44ba0bb01331a2c0c9d6a835d0091c2c9033721afd612c30", json={"name": "Baby Sjedalica Joie", "desc": "https://www.magicbaby.hr/joie-autosjedalica-i-spin-360-grupa-0-1-0-18-kg-konfigurabilni.html"})
print(response.json())
